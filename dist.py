...
VERSION = __import__('dxlmispservice').get_version()
RELEASE_NAME = "dxlmispservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlmispservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlmispservice")])
...
print("\nRemoving dxlmispservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlmispservice.egg-info"))
