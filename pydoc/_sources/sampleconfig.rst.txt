...
The MISP DXL Python Service distribution contains a configuration file (``dxlclient.config``) located
...
(``dxlmispservice.config``) with settings specific to the APIs and event data
that the samples use. The ``[General]`` section in this file must be populated
with appropriate details for the MISP server configuration. For more details
